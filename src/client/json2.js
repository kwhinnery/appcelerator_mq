(function() {
  ...
  function str(key, holder) {
    ...
    if (typeof mq.JSON.stringify !== 'function') {
      mq.JSON.stringify = function (value, replacer, space) {
        ...
        if (replacer && typeof replacer !== 'function' &&
          ...
          throw new Error('mq.JSON.stringify');
        }
    ...
    if (typeof mq.JSON.parse !== 'function') {
      mq.JSON.parse = function (text, reviver) {
      ...
      throw new SyntaxError('mq.JSON.parse');
    };
  }
})();
